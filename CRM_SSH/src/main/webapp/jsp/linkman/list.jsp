...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/linkMan_findAllLinkMan.action"
		method=post>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/linkMan_toEdit.action?lkm_id=<s:property value="lkm_id"/>">修改</a>
													&nbsp;&nbsp;
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><s:property value="totalRecords"/></B>]条记录,第[<B><s:property value="totalPage"/></B>]页
												,每页显示
												...
												[<A href="javascript:to_page(<s:property value="pageNumber-1"/>)">前一页</A>]
												</s:if>
												<B>
												<s:iterator var="i" begin="1" end="totalPage">
													<s:if test="#i == pageNumber">
														<s:property value="#i"/>
													</s:if>
													<s:else>
												...
												[<A href="javascript:to_page(<s:property value="pageNumber+1"/>)">后一页</A>] 
