...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct_uploadProduct.action" method="post" enctype="multipart/form-data">
			&nbsp;
