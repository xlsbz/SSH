...
<script type="text/javascript">
	...
	function change(){
		var check = document.getElementById("changeCheck");
		check.src = "${pageContext.request.contextPath}/check.action?time="+new Date().getTime();
	}
</script>
</head>
<body>
						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="changeCheck" class="captchaImage" src="${pageContext.request.contextPath}/check.action" onclick="change()" title="点击更换验证码">
										</span>
										<s:actionerror/>
									</td>
								</tr>
